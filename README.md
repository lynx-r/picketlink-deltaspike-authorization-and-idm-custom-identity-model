...
======================================================
Author: Shane Bryzak, Aleksey Popryadukhin
Level: Intermediate
...
To restrict who can invoke a method, we create an annotation, called a security binding type. This quickstart has two security binding types - `@Admins`.
...
Also there is IDM JPA custom user model.
